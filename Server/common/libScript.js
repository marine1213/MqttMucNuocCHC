/*This JS contains: debug+DOMinit+MaterializeInit+detectmobilebrowser*/
	// description="init DOM Elements"
  ...
  initElm=(ob,obAts,eIDs)=>{obAts.map((k,id)=>{ob[k]=document.getElementById(eIDs[id]);ob[k+'s']=ob[k].style;ob[k+'c']=ob[k].classList;ob.initiated=true;});}
//=================================================
	// Google Chart API - Load google charts
...
//=================================================
// description="detectmobilebrowser"
